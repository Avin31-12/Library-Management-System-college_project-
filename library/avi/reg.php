...
<?php
    if(isset($_POST['submit'])){
        ...
        if($count==0)
        {mysqli_query($db, "INSERT INTO `student` VALUES('$_POST[first]','$_POST[last]','$_POST[username]','$_POST[Password]','$_POST[roll]','$_POST[email]','$_POST[Contact]','user.png');");       
    ...
    ?>
    <script type="text/javascript">
        alert("registration page will be  already wait for a minute")
        </script>
    <?php
}
?>
