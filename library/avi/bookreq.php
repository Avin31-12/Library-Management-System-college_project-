...
<div class="conatiner">
 <h1 style="text-align:center; color:black; margin:22px;"><u>Requesting for Books</u> </h1>
<?php
if(isset($_SESSION['login_user']))
{
    $q=mysqli_query($db,"SELECT * FROM issue_book WHERE username='$_SESSION[login_user]';");
  if(mysqli_num_rows($q)==0){
      echo"Sorry! please request again.";
       }
     else {
    echo "<table class='table table-bordered table-hover'>";
     echo"<tr style='background-color:#040202'>";
   ...
   while($row=mysqli_fetch_assoc($q))
     {
      echo"<tr style='background-color:#9e9e9e'>";
