...
<head>
 ...
 body{
    ...
    background-image:url(\image\th (4).webp);
...
<body>
    <div class="wrapper">
        <h1>If you have any suggestion or Questions please comment below</h1>
...
<button type="submit" class="btn" name="submit" style="font-size:1rem;"> Comment</button>
    </form>
<div class="scroll">
<?php
