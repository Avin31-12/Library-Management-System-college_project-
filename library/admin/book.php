...
@media screen and (max-height: 450px) {
  ...
  <body  style="margin:-1px;font-size:1.5rem;">
...
<div class="srch">
  ...
  <!-- for deleteing book from databases -->
   <form class="navbar-form" method="post" name="form1">
      <input  class="form=control" type="text" name="bookid" placeholder=" Enter Book ID..." required="">
          <button type=" submit" name="submit1" class="btn btn-dark">Delete
         </button>
   </form>
  ...
  if(isset($_POST['submit1']))
  {
     if(isset($_SESSION['login_user']))
     {
      ...
      else
      {
        ?>
        <script type="text/javascript">
          alert("please login first to delete the book ");
          </script>
          <?php
      }
   }
